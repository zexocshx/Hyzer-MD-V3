...
let handler = async (m, { conn }) => {
	let url = mastub[Math.floor(Math.random() * mastub.length)]
	conn.sendButtonImg(m.chat, url, 'Ancrit sange', wm2, 'NEXT', '.mastubations', m)
}
handler.command = /^(masturbations)$/i
handler.tags = ['nsfw']
handler.help = ['masturbations']
